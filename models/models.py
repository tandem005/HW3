...
class Employee(Model):
    ...
    def get_by_id(cls, id):
        ...
        employee = Employee(employee_dict["name"], int(
            employee_dict["object_id"]), employee_dict["type_of_work"])
    ...
    @classmethod
    def get_by_work(cls, type_of_work):
        employees = cls.get_data()

        for employee in employees:
            if employee['type_of_work'] == type_of_work:
                cls.print_object([employee])
